...
function KaasServes() {
  return (
    ...
    >
      <div className="w-full h-max-[1174px] relative px-32 pt-24 pb-64 mx-auto max-md:px-16 max-sm:px-5 bg-[url(/images/server-background.png)] bg-right bg-no-repeat">
        <KaasServesList />
      </div>
    </section>
  );
