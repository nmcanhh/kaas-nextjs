...
const KaasKeyFeatures: React.FC = () => {
  ...
  return (
    <section className="flex flex-col items-center px-32 py-20 mx-auto max-w-none bg-white bg-opacity-60 max-md:px-10 max-md:py-16 max-md:max-w-[991px] max-sm:px-5 max-sm:py-10 max-sm:max-w-screen-sm">
      <link
      ...
      <header className="flex flex-col gap-8 items-center mb-14">
        ...
        <h2 className="text-2xl text-center text-neutral-800 max-sm:text-xl">
          Stablecoin Onramp &amp; Offramp APIs [ Made for Developers ]
        </h2>
      </header>
